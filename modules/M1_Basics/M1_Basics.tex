...
\pause
\item Maximize with respect to $ q(z) $ with entropy
regularisation:
\begin{equation*}
\underset{q(z)}{\max}~\E[q(z)]{\loga{p(x,z)}} + \Ent{q(z)}
\end{equation*}
...
\item Maximize with respect to $ p(z|x) $ with entropy
regularisation:
\begin{equation*}
...
\pause
\item[\alert{M-step}] Maximize with respect to $ p(z|x) $ with entropy regularisation:
\begin{equation*}
\underset{p(z|x)}{\max}~\E[p(z|x)]{\loga{p(x,z)}} + \Ent{p(z|x)}
\end{equation*}
\end{itemize}
