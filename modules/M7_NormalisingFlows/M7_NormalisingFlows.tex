...
\begin{aligned}
h(x) &= y \\ \pause
p(y) &= p(h^{-1}(y))\djac{h^{-1}}{y} = p(x)\djac{h^{-1}}{y}  \\
...
\begin{equation*}
\begin{aligned}
q(z^{(2)}) &= q(\textcolor{blue}{\epsilon})\djac{h_{1}}{\textcolor{red}{z^{(1)}}}\djac{h_{2}}{z^{(2)}} \\ \pause
&= q(\textcolor{blue}{h_{1}(h_{2}(z^{(2)}))})\djac{h_{1}}{\textcolor{red}{h_{2}(z^{(2)})}}\djac{h_{2}}{z^{(2)}}
\end{aligned}
\end{equation*}
\end{small}
\pause
